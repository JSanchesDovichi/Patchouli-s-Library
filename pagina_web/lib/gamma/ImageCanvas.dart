...
/// See also:
///
///   * [InteractiveViewerPatchouli.builder], whose builder is of this type.
...
/// {@end-tool}
@immutable
class InteractiveViewerPatchouli extends StatefulWidget {
  /// Create an InteractiveViewer.
  InteractiveViewerPatchouli({
    super.key,
  ...
  /// large child.
  InteractiveViewerPatchouli.builder({
    super.key,
    this.clipBehavior = Clip.hardEdge,
    @Deprecated(
      'Use panAxis instead. '
  ...
  ///
  /// Passed with the [InteractiveViewerPatchouli.builder] constructor. Otherwise, the
  ...
  ///
  /// If the [InteractiveViewerPatchouli.builder] constructor is used, then this will be
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      InteractiveViewerPatchouli.getNearestPointOnLine(
  ...
  @override
  State<InteractiveViewerPatchouli> createState() =>
      _InteractiveViewerPatchouliState();
}

class _InteractiveViewerPatchouliState extends State<InteractiveViewerPatchouli>
  ...
  @override
  void didUpdateWidget(InteractiveViewerPatchouli oldWidget) {
...
/// See also:
///
///  * [InteractiveViewerPatchouli.transformationController] for detailed documentation
///    on how to use TransformationController with [InteractiveViewerPatchouli].
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return InteractiveViewerPatchouli.getAxisAlignedBoundingBox(
      boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside =
        InteractiveViewerPatchouli.getNearestPointInside(point, boundary);
...
/// This enum is used to specify the behavior of the [InteractiveViewerPatchouli] when
